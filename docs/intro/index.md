...
!!!tip "Quick Start"
    Ready to try TAPPaaS? Start with our [Installation Guide](../getting-started/installation.md) to get up and running in minutes.
...
2. Follow the [Quick Start](../getting-started/quickstart.md) to deploy your first app
...
- [Getting Started](../getting-started/index.md) - Install and deploy your first application
