...
!!!tip "Getting Started is Simple"
    You don't need to understand everything to get value from TAPPaaS. All you need is an older computer or server and a few hours to follow our [installation guide](../getting-started/installation.md).
...
- [Getting Started](../getting-started/index.md) - Start using TAPPaaS
