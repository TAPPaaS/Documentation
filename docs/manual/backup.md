---
title: Backup
description: Proxmox Backup Server operations and management for TAPPaaS
---

# Backup

This guide covers operating and managing Proxmox Backup Server (PBS) for your TAPPaaS infrastructure. For installation, see the [Backup Installation](../installation/foundation/backup.md) guide.
