...
[GitHub milestones](https://codeberg.org/TAPPaaS/TAPPaaS/milestones)**, so nothing here
can go stale.
...
the current focus is **Version 2.0** — the [ADR-007 taxonomy](../installation/preparation.md#4-branch-selection)
and this rebuilt documentation site are part of it.

## How we plan

- **Milestones drive everything.** Each phase is broken into
  [GitHub milestones](https://codeberg.org/TAPPaaS/TAPPaaS/milestones) with issues
  attached; that's the single source of truth for "when" and "what exactly".
- **Architecture is decided in ADRs** in the
  [source repo](https://codeberg.org/TAPPaaS/TAPPaaS/src/branch/main/docs/ADR) — significant
...
| What 2.0 means for you | [Branch Selection](../installation/preparation.md#4-branch-selection) |
